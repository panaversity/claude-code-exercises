...
2. **lesson-plans/** (5 files) — Detailed plan for each lesson with:
   - Learning objectives
   - Teaching flow (intro → demo → practice → recap)
   - Estimated time for each section
   - Materials needed
3. **worksheets/** (5 files) — Student exercise for each lesson
4. **quiz-with-answers.md** — 20 questions (mix of multiple choice and short answer) with answer key
...
- Everything should be immediately usable by an instructor
